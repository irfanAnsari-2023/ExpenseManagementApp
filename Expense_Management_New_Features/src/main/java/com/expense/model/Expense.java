...
public class Expense {
	...
	public String toString() {
		return "Expense [id=" + id + ", claimType=" + claimType + ", dateOfExpense=" + dateOfExpense + ", amount="
				+ amount + ", claimMonth=" + claimMonth + ", claimYear=" + claimYear + ", status=" + status + "]";
	}
    ...
    // Getter and setter methods for approvedDate
    ...
    // Getter and setter methods for rejectedDate
